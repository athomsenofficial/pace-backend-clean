...
class DocumentMetadata(BaseModel):
    ...
    date: Optional[date_type] = Field(default=None, description="Document date")
    phone: Optional[str] = Field(default=None, example="DSN 315-784-1234")
    email: Optional[str] = Field(default=None, example="john.doe@us.af.mil")
...
class SignatureBlock(BaseModel):
    ...
    date_signed: Optional[date_type] = None
...
class MFRContent(BaseModel):
    ...
    distribution_list: Optional[List[str]] = Field(default=None, description="Distribution list recipients")
    attachments: Optional[List[str]] = Field(default=None, description="List of attachments")


class MemoContent(BaseModel):
    """Content for Official Memorandum"""
    to_line: str = Field(..., example="51 FSS/CCF", description="TO: recipient")
    thru_line: Optional[str] = Field(default=None, example="51 FSS/CC", description="THRU: routing (optional)")
    subject: str = Field(..., description="Subject line (will be capitalized)")
    body_paragraphs: List[str] = Field(..., min_items=1, description="Body paragraphs (numbered)")
    distribution_list: Optional[List[str]] = Field(default=None)
...
class AppointmentContent(BaseModel):
    ...
    appointee_ssan: Optional[str] = Field(default=None, example="1234", description="Last 4 of SSN")
    ...
    effective_date: date_type = Field(..., description="Appointment effective date")
    termination_date: Optional[date_type] = Field(default=None, description="Appointment end date (if applicable)")
...
class AdministrativeActionContent(BaseModel):
    ...
    member_ssan: Optional[str] = Field(default=None, example="1234", description="Last 4 of SSN")
    subject: str = Field(..., description="Subject line")
    incident_date: date_type = Field(..., description="Date of incident")
    ...
    previous_actions: Optional[List[str]] = Field(default=None, description="Previous counseling/actions")
    filing_location: Optional[Literal["PIF", "DCAF", "UPRG"]] = Field(default=None, description="For LOR only")
    appeal_rights: Optional[str] = Field(default=None, description="For LOA/LOR - appeal process")
